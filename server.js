...
// Initialize all database files as EMPTY arrays
const dataFiles = [
    'users.json', 
    'schools.json', 
    'students.json', 
...
app.post('/api/teachers', (req, res) => {
    ...
    const { firstName, lastName, email, subject, phone, schoolId } = req.body;
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🌐 Visit: https://my-school-bw-c0gh.onrender.com`);
    console.log(`📡 API: https://my-school-bw-c0gh.onrender.com/api/health`);
});